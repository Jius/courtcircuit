(function($) {
  ...
  function htmlConstruct(week)
  {
  	...
  	$.each(week, function( index, day ) {
  		titleDay = day;
  		day = day.toLowerCase();
			fullView = '<div class="all"><div class="row"><div class="col s6"><input placeholder="De" id="hour-start-' + day + '" type="text" class="hour timepicker full" name="hour-start-' + day + '"></div><div class="col s6"><input placeholder="À" id="hour-end-' + day + '" type="text" class="hour timepicker full" name="hour-end-' + day + '"></div></div></div>';
			...
			splitView = '<div class="split">Matin:<div class="row"><div class="col s6"><input placeholder="De" id="hour-start-am-' + day + '" type="text" class="hour timepicker am" name="hour-start-am-' + day + '"></div><div class="col s6"><input placeholder="À " id="hour-end-am-' + day + '" type="text" class="hour timepicker am" name="hour-end-am-' + day + '"></div></div>Après-midi:<div class="row"><div class="col s6"><input placeholder="De " id="hour-start-pm-' + day + '" type="text" class="hour timepicker pm" name="hour-start-pm-' + day + '"></div><div class="col s6"><input placeholder="À " id="hour-end-pm-' + day + '" type="text" class="hour timepicker pm" name="hour-end-pm-' + day + '"></div></div></div>';
